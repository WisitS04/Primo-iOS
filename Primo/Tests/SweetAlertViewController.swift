...
//  Primo
//
//  Created by Macmini on 6/6/2560 BE.
...
class SweetAlertViewController: UIViewController {
    ...
    @IBAction func subtitleAlert(_ sender: AnyObject) {
        ...
        _ = SweetAlert().showAlert("Here's a message!",
                                   subTitle: "It's pretty, isn't it?",
                                   style: AlertStyle.none)
    }
    
    @IBAction func sucessAlert(_ sender: AnyObject) {
        _ = SweetAlert().showAlert("Good job!",
                                   subTitle: "You clicked the button!",
                                   style: AlertStyle.success)
    }
    
    @IBAction func warningAlert(_ sender: AnyObject) {
        _ = SweetAlert().showAlert("Are you sure?",
                                   subTitle: "You file will permanently delete!",
                                   style: AlertStyle.warning, buttonTitle:"Cancel",
                                   buttonColor:UIColor.colorFromRGB(0xD0D0D0),
                                   otherButtonTitle:  "Yes, delete it!",
                                   otherButtonColor: UIColor.colorFromRGB(0xDD6B55))
        { (isOtherButton) -> Void in
            if isOtherButton == true {
                print("Cancel Button  Pressed", terminator: "")
            } else {
                _ = SweetAlert().showAlert("Deleted!",
                                           subTitle: "Your imaginary file has been deleted!",
                                           style: AlertStyle.success)
            }
        }
    }
    ...
    @IBAction func cancelAndConfirm(_ sender: AnyObject) {
        _ = SweetAlert().showAlert("Are you sure?",
                                   ...
                                   buttonTitle:"No, cancel plx!",
                                   buttonColor:UIColor.colorFromRGB(0xD0D0D0),
                                   otherButtonTitle:  "Yes, delete it!",
                                   otherButtonColor: UIColor.colorFromRGB(0xDD6B55))
        { (isOtherButton) -> Void in
            if isOtherButton == true {
                _ = SweetAlert().showAlert("Cancelled!",
                                           subTitle: "Your imaginary file is safe",
    ...
    @IBAction func customIconAlert(_ sender: AnyObject) {
        _ = SweetAlert().showAlert("Sweet!",
                                   ...
                                   style: AlertStyle.customImag(imageFile: "thumb.jpg"))
    }
}
